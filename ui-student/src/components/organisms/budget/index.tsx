...
import { usePurchasesByOrganizationQuery, useEventsByOrganizationQuery } from "../../../generated";
                    ...
                    <Card className="mt-4">
                        ...
                        <div style={{ marginTop: 12 }}>
                            {(() => {
                                ...
                                const eventMap = new Map<string, string>((eventsData?.getEventsByOrganization ?? []).map((e: any) => [e.id, e.title]));
                                const rows = (purchasesData?.getPurchasesByOrganization ?? []).map((p: any) => ({
                                    key: p.id,
