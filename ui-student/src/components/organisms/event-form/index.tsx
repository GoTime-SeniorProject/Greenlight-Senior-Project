...
import { useCreateEventMutation, useUpdateEventMutation, useDeleteEventMutation, useGetOnCampusQuery, useGetEventByIdQuery } from "../../../generated";
...
export function EventForm() {
    ...
    useEffect(() => {
        if (existingEventData?.getEvent && !loadingEvent && !hasPopulatedRef.current) {
            hasPopulatedRef.current = true;
            const ev = existingEventData.getEvent;
    ...
    const buildMutationInput = (data: any, eventStatus: string = "REVIEW", isUpdate: boolean = false) => {
        ...
        if (data.location_type === "On-Campus" && locationsData?.getLocations) {
            ...
            if (selectedBuilding && selectedRoomTitle) {
                const matchedLocation = locationsData.getLocations.find((loc) => {
