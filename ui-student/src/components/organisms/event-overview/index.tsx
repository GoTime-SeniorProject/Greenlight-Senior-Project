...
import { useGetEventByIdQuery, useGetUsersQuery, useGetUserQuery } from '../../../generated';
...
export function EventOverviewContent() {
    ...
    const tripLeader = tripLeaderData?.getUser || null;
    ...
    useEffect(() => {
        if (eventId) {
            ...
            if (!loading && data?.getEvent) {
                const ev = data.getEvent;
    ...
    return (
        <div className="container m-8 w-auto">
            ...
            {/* ── Hero / Event Image ── */}
            {(() => {
                const rawImg = data?.getEvent?.eventImg;
                            ...
                            {formData?.minors && (
                                <div style={{ marginTop: 24 }}>
                                    ...
                                    {renderField(
                                        ...
                                        (() => {
                                            const contact = userData?.getUsers?.find(
